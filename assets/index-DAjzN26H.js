...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function es(e,t,n){let r=new Float32Array(Bo),i=new K(0,1,0);return new fa({name:`SphericalGaussianBlur`,defines:{n:Bo,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:rs(),fragmentShader:`
	...
	`}var is=class extends Gt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new qi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
	...
	if ( coord.x >= 1.0 ) {
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}};Cu.BlurDirectionX=new G(1,0),Cu.BlurDirectionY=new G(0,1);var wu={name:`OutputShader`,uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
		precision highp float;
		...
		}`},Tu=class extends pu{constructor(){super(),this.isOutputPass=!0,this.uniforms=la.clone(wu.uniforms),this.material=new pa({name:wu.name,uniforms:this.uniforms,vertexShader:wu.vertexShader,fragmentShader:wu.fragmentShader}),this._fsQuad=new gu(this.material),this._outputColorSpace=null,this._toneMapping=null}render(e,t,n){this.uniforms.tDiffuse.value=n.texture,this.uniforms.toneMappingExposure.value=e.toneMappingExposure,(this._outputColorSpace!==e.outputColorSpace||this._toneMapping!==e.toneMapping)&&(this._outputColorSpace=e.outputColorSpace,this._toneMapping=e.toneMapping,this.material.defines={},J.getTransfer(this._outputColorSpace)===`srgb`&&(this.material.defines.SRGB_TRANSFER=``),this._toneMapping===1?this.material.defines.LINEAR_TONE_MAPPING=``:this._toneMapping===2?this.material.defines.REINHARD_TONE_MAPPING=``:this._toneMapping===3?this.material.defines.CINEON_TONE_MAPPING=``:this._toneMapping===4?this.material.defines.ACES_FILMIC_TONE_MAPPING=``:this._toneMapping===6?this.material.defines.AGX_TONE_MAPPING=``:this._toneMapping===7?this.material.defines.NEUTRAL_TONE_MAPPING=``:this._toneMapping===5&&(this.material.defines.CUSTOM_TONE_MAPPING=``),this.material.needsUpdate=!0),this.renderToScreen===!0?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},Eu=58879;function Du(e){let t=new Mn;t.background=new Y(395273),t.fog=new jn(395273,.0085);let n=new Ga(52,window.innerWidth/window.innerHeight,.5,2e3);n.position.set(78,52,88);let r=new Hl({canvas:e,antialias:!0,powerPreference:`high-performance`});r.setSize(window.innerWidth||1,window.innerHeight||1,!1),r.setPixelRatio(Math.min(window.devicePixelRatio,1.25)),r.toneMapping=4,r.toneMappingExposure=1.05;let i=new $l(n,r.domElement);i.enableDamping=!0,i.dampingFactor=.06,i.maxPolarAngle=Math.PI*.487,i.minDistance=18,i.maxDistance=260,i.target.set(0,14,0),t.add(new Za(2240568,.55));let a=new Xa(10476520,.35);a.position.set(-60,90,40),t.add(a);let o=new qa(Eu,60,220,2);o.position.set(0,6,0),t.add(o);let s=new bu(r);s.addPass(new xu(t,n));let c=.5,l=new Cu(new G(window.innerWidth*c,window.innerHeight*c),.85,.7,.22);s.addPass(l),s.addPass(new Tu);function u(){let t=e.clientWidth||window.innerWidth||1,i=e.clientHeight||window.innerHeight||1;n.aspect=t/i,n.updateProjectionMatrix(),r.setSize(t,i,!1),s.setSize(t,i),l.setSize(t*c,i*c)}return window.addEventListener(`resize`,u),new ResizeObserver(u).observe(e),{scene:t,camera:n,renderer:r,controls:i,composer:s,bloom:l,resize:u}}function Ou(e,t,n,r){let i=new Set,a={active:!1,yaw:0,pitch:0,speed:46},o=Math.PI/2-.05;function s(){if(a.active)return;let i=new K;e.getWorldDirection(i),a.yaw=Math.atan2(-i.x,-i.z),a.pitch=Math.asin(Tt.clamp(i.y,-1,1)),a.active=!0,t.enabled=!1,n.requestPointerLock?.(),r?.(!0)}function c(){if(!a.active)return;a.active=!1,i.clear(),document.pointerLockElement&&document.exitPointerLock();let n=new K;e.getWorldDirection(n),t.target.copy(e.position).add(n.multiplyScalar(40)),t.enabled=!0,t.update(),r?.(!1)}function l(e){if(!a.active)return;let t=.0022;a.yaw-=e.movementX*t,a.pitch=Tt.clamp(a.pitch-e.movementY*t,-o,o)}window.addEventListener(`keydown`,e=>{let t=e.target;if(!(t&&(t.tagName===`INPUT`||t.tagName===`TEXTAREA`||t.isContentEditable))){if(e.code===`KeyF`){e.preventDefault(),a.active?c():s();return}if(e.code===`Escape`){c();return}a.active&&(i.add(e.code),e.code===`Space`&&e.preventDefault())}}),window.addEventListener(`keyup`,e=>i.delete(e.code)),document.addEventListener(`mousemove`,l),document.addEventListener(`pointerlockchange`,()=>{!document.pointerLockElement&&a.active&&c()});function u(t){if(!a.active)return;e.quaternion.setFromEuler(new an(a.pitch,a.yaw,0,`YXZ`));let n=new K(0,0,-1).applyQuaternion(e.quaternion),r=new K(1,0,0).applyQuaternion(e.quaternion),o=new K;if(i.has(`KeyW`)&&o.add(n),i.has(`KeyS`)&&o.sub(n),i.has(`KeyD`)&&o.add(r),i.has(`KeyA`)&&o.sub(r),i.has(`Space`)&&(o.y+=1),(i.has(`ShiftLeft`)||i.has(`ControlLeft`))&&--o.y,!o.lengthSq())return;let s=i.has(`ShiftRight`)?2.6:1;e.position.addScaledVector(o.normalize(),a.speed*s*t),e.position.y<2&&(e.position.y=2)}return{update:u,enter:s,exit:c,get active(){return a.active}}}function ku(e,t,n,r=46,i=22){let a=e.position.clone(),o=t.target.clone(),s=a.clone().sub(o).setY(0).normalize(),c=n.clone().add(s.multiplyScalar(r)).setY(n.y+i),l=performance.now();function u(r){let i=Math.min((r-l)/900,1),s=i<.5?4*i*i*i:1-(-2*i+2)**3/2;e.position.lerpVectors(a,c,s),t.target.lerpVectors(o,n,s),t.update(),i<1&&requestAnimationFrame(u)}requestAnimationFrame(u)}var Au=new Y(Eu),ju=new Qi(1,1,1),Mu=[58879,16723349,16770560,8191789,11619839,16738816,2976767,16726832],Nu=658704,Pu=e=>Mu[Math.abs(Math.round(e))%Mu.length];function Fu(e){let t=Math.abs(Math.round(e))%2147483647||7;return()=>(t=t*48271%2147483647)/2147483647}var Iu=new Map;function Lu(e,t,n,r,i=0){let a=`${e}x${t}:${n}:${r}:${i}`,o=Iu.get(a);return o||(o=Ru(e,t,n,r,i*13+5),Iu.set(a,o)),o}function Ru(e,t,n,r,i){let o=document.createElement(`canvas`);o.width=e*8,o.height=t*8;let s=o.getContext(`2d`);s.fillStyle=`#000`,s.fillRect(0,0,o.width,o.height);let c=new Y(r),l=c.clone().lerp(new Y(16777215),.65),d=c.clone().multiplyScalar(.45),f=e=>`#${e.getHexString()}`,p=Fu(i);for(let r=0;r<t;r++)for(let t=0;t<e;t++){if(p()>n)continue;let e=p();s.fillStyle=f(e>.86?l:e>.3?c:d),s.fillRect(t*8+3/2,r*8+3/2,5,5)}let m=new Ji(o);return m.magFilter=a,m.minFilter=u,m.colorSpace=Re,m}function zu(e,{size:t=128,color:n=`#00e5ff`,width:r=10}={}){let i=document.createElement(`canvas`);i.width=512,i.height=128;let a=i.getContext(`2d`);a.fillStyle=n,a.font=`600 ${t*.52}px ui-monospace, Consolas, monospace`,a.textAlign=`center`,a.textBaseline=`middle`,a.shadowColor=n,a.shadowBlur=18,a.fillText(e,i.width/2,i.height/2);let o=new Ji(i);o.colorSpace=Re;let s=new Kr(new Mr({map:o,transparent:!0,depthWrite:!1}));return s.scale.set(r,r/4,1),s}var Bu=600,Vu=1024,Hu=null,Uu=null,Wu=null;function Gu(){Hu=document.createElement(`canvas`),Hu.width=Hu.height=Vu,Uu=Hu.getContext(`2d`),Uu.fillStyle=`#000`,Uu.fillRect(0,0,Vu,Vu)}function Ku(e,t,n,r=22,i=.55){Uu||Gu();let a=(e+Bu/2)/Bu*Vu,o=(t+Bu/2)/Bu*Vu,s=r/Bu*Vu,c=new Y(n),l=Uu.createRadialGradient(a,o,0,a,o,s);l.addColorStop(0,`rgba(${c.r*255|0},${c.g*255|0},${c.b*255|0},${i})`),l.addColorStop(1,`rgba(0,0,0,0)`),Uu.globalCompositeOperation=`lighter`,Uu.fillStyle=l,Uu.beginPath(),Uu.arc(a,o,s,0,Math.PI*2),Uu.fill()}function qu(){Wu&&(Wu.needsUpdate=!0)}function Ju(e){let t=new Cn;Uu||Gu(),Wu=new Ji(Hu),Wu.colorSpace=Re;let n=new X(new ea(Bu,Bu),new ma({color:329482,roughness:.85,metalness:.1,emissive:16777215,emissiveMap:Wu,emissiveIntensity:1.15}));n.rotation.x=-Math.PI/2,n.position.y=-.02,t.add(n);let r=new X(ju,new ma({color:724755,roughness:.75,metalness:.2}));r.scale.set(210,2.4,210),r.position.y=-1.2,t.add(r);let i=new Co(Bu,60,Eu,666161);i.material.transparent=!0,i.material.opacity=.07,t.add(i);let a=new ni({color:1119771}),o=new ni({color:16770560,transparent:!0,opacity:.5}),s=new ni({color:14677759,transparent:!0,opacity:.32});for(let e of[0,Math.PI/2]){let n=new X(new ea(Bu,16),a);n.rotation.set(-Math.PI/2,0,e),n.position.y=.01,t.add(n);for(let n=-14;n<=14;n++){if(Math.abs(n)<2)continue;let r=new X(new ea(7,.5),o);r.rotation.set(-Math.PI/2,0,e);let i=n*20;r.position.set(e?0:i,.03,e?i:0),t.add(r)}for(let n of[-1,1])for(let r=0;r<7;r++){let i=new X(new ea(1.1,14),s);i.rotation.set(-Math.PI/2,0,e);let a=n*30+(r-3)*2;i.position.set(e?0:a,.04,e?a:0),e&&(i.rotation.z=Math.PI/2),t.add(i)}}return e.add(t),t}function Yu({w:e,h:t,d:n,hue:r,seed:i,cols:a,rows:o,litChance:s,steps:c=2}){let l=new Cn,u=Fu(i),d=[],f=Lu(a,o,s,r,Math.floor(u()*4)),p=new ma({color:Nu,roughness:.62,metalness:.35,emissive:new Y(r),emissiveMap:f,emissiveIntensity:.95});d.push(p);let m=new X(ju,p);m.scale.set(e,t,n),m.position.y=t/2,l.add(m);let h=t,g=e,_=n;for(let r=0;r<c;r++){let r=t*(.16+u()*.13);g*=.62+u()*.16,_*=.62+u()*.16;let i=new X(ju,p);i.scale.set(g,r,_),i.position.set((u()-.5)*(e-g)*.5,h+r/2,(u()-.5)*(n-_)*.5),l.add(i),h+=r}let v=new ni({color:r,transparent:!0,opacity:.9});d.push(v);let y=t*(.5+u()*.35);for(let[t,r,i,a]of[[e+.3,.45,0,n/2],[e+.3,.45,0,-n/2],[.45,n+.3,e/2,0],[.45,n+.3,-e/2,0]]){let e=new X(ju,v);e.scale.set(t,.5,r),e.position.set(i,y,a),l.add(e)}let b=new ma({color:856598,roughness:.8,metalness:.3}),x=1+Math.floor(u()*3);for(let e=0;e<x;e++){let e=new X(ju,b),t=g*(.18+u()*.22);e.scale.set(t,t*(.5+u()),t),e.position.set((u()-.5)*g*.6,h+e.scale.y/2,(u()-.5)*_*.6),l.add(e)}return{group:l,body:m,bodyMat:p,mats:d,topY:h}}function Xu(e,t){let n=new Cn,r=new Map,i=new X(ju,new ma({color:659990,roughness:.6,metalness:.6}));i.scale.set(24,2,24),i.position.y=1,n.add(i);let a=e=>{let[t,n]=String(e).split(`:`).map(Number);return t*60+(n||0)},o=t.filter(e=>e.type!==`weekly`).sort((e,t)=>a(e.at||`99:99`)-a(t.at||`99:99`)),s=t.filter(e=>e.type===`weekly`),c=[...o,...s];c.forEach((e,t)=>{let i=2+7*t+7/2,a=t%2?.9:0,o=e.type===`weekly`,s=o?16770560:Mu[t%Mu.length],c=o?new ma({color:1314822,roughness:.15,metalness:.85,emissive:new Y(s),emissiveIntensity:.7,transparent:!0,opacity:.93}):new ma({color:Nu,roughness:.6,metalness:.4,emissive:new Y(s),emissiveMap:Lu(7,4,.62,s,t),emissiveIntensity:.95}),l=new X(ju,c);l.scale.set(16-a,6.4,16-a),l.position.y=i,l.userData.agentId=e.id,l.userData.kind=`floor`,n.add(l);let u=new X(ju,new ni({color:s,transparent:!0,opacity:.35}));u.scale.set(16.5,.34,16.5),u.position.y=i+7/2-.25,n.add(u);let d=zu(e.at||(o?`WEEKLY`:e.name),{width:12,color:`#${new Y(s).getHexString()}`});d.position.set(0,i,10.4),n.add(d);let f=[];if(!o){let e=new ni({color:new Y(s).lerp(new Y(16777215),.5),transparent:!0,opacity:0}),t=(16-a)/2,r=(16-a)/2,o=[[-4,0,r+.06,0],[1.5,0,r+.06,0],[t+.06,0,-2,Math.PI/2],[-t-.06,0,3,Math.PI/2]];for(let[t,,r,a]of o){let o=new X(ju,e.clone());o.scale.set(a?.12:1.1,1.8,a?1.1:.12),o.position.set(t,i-1.2,r),n.add(o),f.push(o)}}r.set(e.id,{mesh:l,mat:c,light:null,band:u,label:d,y:i,hue:s,crew:f})});let l=2+7*c.length;Ku(0,0,Eu,60,.5);for(let e=0;e<3;e++){let t=new X(ju,new ma({color:793120,metalness:.8,roughness:.3,emissive:Au.clone(),emissiveIntensity:.3})),r=12-e*3.4;t.scale.set(r,1.6,r),t.position.y=l+.8+e*1.6,n.add(t)}let u=new X(new na(1.1,12,12),new ni({color:12581375}));u.position.y=l+7.5,n.add(u);let d=new X(new ra(13,.22,6,48),new ni({color:Eu,transparent:!0,opacity:.55}));d.rotation.x=Math.PI/2,d.position.y=l+1,n.add(d);let f=zu(`TRADING TOWER`,{width:26});return f.position.set(0,l+12,0),n.add(f),e.add(n),{group:n,floors:r,beacon:u,ring:d,topY:l}}var Zu={hub:{pos:[-46,0,-20],w:26,h:13,d:20,label:`HUB HQ`,cols:10,rows:4,hue:58879},studio:{pos:[40,0,-30],w:11,h:26,d:11,label:`STUDIO`,cols:5,rows:9,hue:11619839},factory:{pos:[-34,0,40],w:30,h:10,d:22,label:`FACTORY`,cols:12,rows:3,hue:16738816}},Qu=[[34,0,24],[52,0,38],[34,0,52],[62,0,14],[76,0,44],[48,0,68]];function $u(e,t){let n=new Map,r=0;for(let i of t){let t=Zu[i.district]||{pos:Qu[r++%Qu.length],w:12,h:9+i.id.length%5*2,d:12,label:(i.name||i.id).toUpperCase().slice(0,14),cols:5,rows:4,hue:Pu(i.id.length*3+1)},a=new Cn;a.position.set(...t.pos);let o=Yu({w:t.w,h:t.h,d:t.d,hue:t.hue,seed:t.label.length+7,cols:t.cols,rows:t.rows,litChance:.45,steps:2});o.body.userData.agentId=i.id,o.body.userData.kind=`building`,a.add(o.group),Ku(t.pos[0],t.pos[2],t.hue,Math.max(t.w,t.d)*1.5,.5);let s=zu(t.label,{width:18,color:`#${new Y(t.hue).getHexString()}`});if(s.position.set(0,o.topY+5,0),a.add(s),i.district===`studio`){let e=new X(ju,new ni({color:t.hue}));e.scale.set(.4,14,.4),e.position.y=o.topY+7,a.add(e)}e.add(a),n.set(i.id,{group:a,mesh:o.body,mat:o.bodyMat,mats:o.mats,light:null,label:s,height:o.topY,hue:t.hue})}return n}var ed=6;function td(e,t=140){let n=new Cn,r=Fu(11),i=Array.from({length:ed},()=>[]),a=new Jt;for(let e=0;e<t;e++){let t=r()*Math.PI*2,n=66+r()*180,o=8+r()*58,s=7+r()*13,c=Math.cos(t)*n,l=Math.sin(t)*n;a.makeScale(s,o,s),a.setPosition(c,o/2,l);let u=e%ed;if(i[u].push(a.clone()),n<150&&r()>.45&&Ku(c,l,Mu[u],s*1.4,.3),r()>.55){let e=o*(.2+r()*.2),t=s*(.55+r()*.2),n=new Jt().makeScale(t,e,t);n.setPosition(c,o+e/2,l),i[u].push(n)}}return i.forEach((e,t)=>{let r=Mu[t],i=new Ti(ju,new ma({color:Nu,roughness:.6,metalness:.4,emissive:new Y(r),emissiveMap:Lu(5,9,.2+t*.04,r,t),emissiveIntensity:.55}),e.length);e.forEach((e,t)=>i.setMatrixAt(t,e)),i.instanceMatrix.needsUpdate=!0,i.frustumCulled=!1,n.add(i)}),e.add(n),n}var nd={active:{emissive:2.2,opacity:.95},idle:{emissive:.85,opacity:.4},dark:{emissive:.3,opacity:.14},error:{emissive:1.7,opacity:.9,color:16726832}};function rd(e,t){if(!e)return;let n=nd[t]||nd.dark;e.targetEmissive=n.emissive;let r=n.color?new Y(n.color):new Y(e.hue||58879);e.mat.emissive.copy(r),e.light&&e.light.color.copy(r),e.band&&(e.band.material.color.copy(r),e.band.material.opacity=n.opacity),e.label&&(e.label.material.opacity=t===`dark`?.32:1)}function id(e,t,n=0){if(e.targetEmissive==null)return;let r=Math.min(t*3,1);if(e.mat.emissiveIntensity+=(e.targetEmissive-e.mat.emissiveIntensity)*r,e.light&&(e.light.intensity+=((e.targetLight||0)-e.light.intensity)*r),e.crew?.length){let r=e.targetEmissive>=nd.active.emissive;e.crew.forEach((e,i)=>{let a=r?.6+Math.sin(n*2.2+i*1.7)*.28:0;e.material.opacity+=(a-e.material.opacity)*Math.min(t*2.5,1)})}}new Y(Eu);var ad=new $i(.5,1.5,4,8);function od(e=Eu){let t=new Cn,n=new X(ad,new ma({color:859170,metalness:.4,roughness:.4,emissive:new Y(e),emissiveIntensity:1.4}));n.position.y=1.3,t.add(n);let r=new Kr(new Mr({color:e,transparent:!0,opacity:.5,depthWrite:!1,blending:2}));return r.scale.set(4,4,1),r.position.y=1.4,t.add(r),{group:t,body:n,halo:r}}function sd(e,t){let n=[];return t.forEach((r,i)=>{let a=od(Mu[i%Mu.length]),o=24+i%4*4.5,s=i/t.length*Math.PI*2;a.group.position.set(Math.cos(s)*o,0,Math.sin(s)*o),a.group.visible=!1,e.add(a.group),n.push({...a,agent:r,radius:o,curRadius:o+70,angle:s,speed:.12+i%3*.045,status:`dark`})}),n}var cd=35;function ld(){let e=new Date(new Date().toLocaleString(`en-US`,{timeZone:`America/New_York`}));return{mins:e.getHours()*60+e.getMinutes(),weekend:e.getDay()===0||e.getDay()===6}}function ud(e){if(!e)return null;let[t,n]=String(e).split(`:`).map(Number);return t*60+(n||0)}function dd(e,t,n){if(n&&e.agent.type!==`weekly`)return`home`;let r=ud(e.agent.at);if(r==null)return e.status===`active`?`working`:`home`;let i=t-r;return i<-25?`home`:i<0?`commuting`:i<=cd?`working`:i<=55?`leaving`:`home`}function fd(e,t,n){let{mins:r,weekend:i}=ld();for(let a of e){let e=a.status===`active`,o=e?`working`:dd(a,r,i);if(o===`home`){a.body.material.emissiveIntensity+=(0-a.body.material.emissiveIntensity)*Math.min(t*3,1),a.halo.material.opacity+=(0-a.halo.material.opacity)*Math.min(t*3,1),a.halo.material.opacity<.02&&(a.group.visible=!1);continue}a.group.visible=!0;let s=o===`commuting`?a.radius+70:o===`leaving`?a.radius+55:a.radius;a.curRadius+=(s-a.curRadius)*Math.min(t*.45,1),(o===`working`||o===`commuting`)&&(a.angle+=a.speed*t);let c=Math.cos(a.angle)*a.curRadius,l=Math.sin(a.angle)*a.curRadius;a.group.position.x+=(c-a.group.position.x)*Math.min(t*2,1),a.group.position.z+=(l-a.group.position.z)*Math.min(t*2,1),a.group.rotation.y=-a.angle+Math.PI/2;let u=o!==`working`||e;a.body.position.y=1.3+(u?Math.sin(n*6+a.angle*3)*.09:0);let d=o===`working`?2:1.1;a.body.material.emissiveIntensity+=(d-a.body.material.emissiveIntensity)*Math.min(t*3,1);let f=o===`working`?.45+Math.sin(n*3+a.angle)*.12:.2;a.halo.material.opacity+=(f-a.halo.material.opacity)*Math.min(t*3,1)}}function pd(e,t=18){let n=new na(.55,8,8),r=[];for(let i=0;i<t;i++){let t=new X(n,new ni({color:Eu,transparent:!0,opacity:0,blending:2,depthWrite:!1}));t.visible=!1,e.add(t),r.push({mesh:t,t:1,from:new K,to:new K,dur:1})}return{fire(e,t,n=Eu){let i=r.find(e=>e.t>=1);i&&(i.from.copy(e),i.to.copy(t),i.t=0,i.dur=.7+e.distanceTo(t)/90,i.mesh.material.color.set(n),i.mesh.visible=!0)},update(e){for(let t of r){if(t.t>=1)continue;t.t=Math.min(t.t+e/t.dur,1);let n=t.t;t.mesh.position.lerpVectors(t.from,t.to,n),t.mesh.position.y+=Math.sin(n*Math.PI)*12,t.mesh.material.opacity=Math.sin(n*Math.PI)*.95,t.t>=1&&(t.mesh.visible=!1)}}}}var md=`http://127.0.0.1:8787`,hd=`https://raw.githubusercontent.com/AztecNightmare365/claude-trading-tasks/main/city-state.json`,gd=`./roster.json`,_d=`city-bridge-token`,vd=typeof window<`u`?window.__HUB_TOKEN:null,yd=null;try{yd=localStorage.getItem(_d)}catch{}var bd=vd||yd,xd=!1;function Sd(e){try{localStorage.setItem(_d,String(e).trim())}catch{}location.reload()}var Cd=typeof window<`u`&&!!window.__HUB_REMOTE,wd=null,Td=`unknown`,Ed=()=>Td===`bridge`;function Dd(e={}){let t={...e};return bd&&(t.Authorization=`Bearer ${bd}`),t}async function Od(e,t=1500){try{let n=new AbortController,r=setTimeout(()=>n.abort(),t),i=await fetch(`${e}/health`,{headers:Dd(),signal:n.signal});return clearTimeout(r),i.ok?!!(await i.json()).bridge:!1}catch{return!1}}async function kd(e){try{let t=await fetch(`${e}/city/state`,{headers:Dd()});return t.status===401||t.status===403?(xd=!0,!1):t.ok}catch{return!1}}async function Ad(){for(let e of[Cd?``:null,md])if(e!==null&&await Od(e)&&await kd(e))return wd=e,Td=`bridge`,Td;return wd=null,Td=`static`,Td}async function jd(e,t={}){if(wd===null)throw Error(`no bridge`);let n=await fetch(wd+e,{...t,headers:Dd(t.headers)});if(!n.ok)throw Error(`${e} -> ${n.status}`);return n.json()}var Md=null;async function Nd(){return Md||(Md=(await(await fetch(gd,{cache:`no-cache`})).json()).agents||[],Md)}function Pd(){let e=new Date(new Date().toLocaleString(`en-US`,{timeZone:`America/New_York`})),t=e.getHours()*60+e.getMinutes(),n=e.getDay(),r=n===0||n===6,i=`closed`;return r||(t>=570&&t<960?i=`open`:t>=240&&t<570?i=`premarket`:t>=960&&t<1200&&(i=`afterhours`)),{phase:i,weekend:r,etTime:`${String(e.getHours()).padStart(2,`0`)}:${String(e.getMinutes()).padStart(2,`0`)}`}}var Fd=20;function Id(e,t){if(!e.at||t.weekend)return!1;let[n,r]=e.at.split(`:`).map(Number),[i,a]=t.etTime.split(`:`).map(Number),o=n*60+r,s=i*60+a;return s>=o&&s<o+Fd}async function Ld(){let[e,t]=await Promise.all([Nd(),fetch(`${hd}?t=${Date.now()}`,{cache:`no-store`}).then(e=>e.ok?e.json():null).catch(()=>null)]),n=Pd(),r=[];if(t){t.portfolio&&r.push({id:`snap`,ts:t.ts,agent:`city_market_watch`,kind:`snapshot`,msg:`account $${Number(t.portfolio.totalValue).toFixed(2)} - ${(t.portfolio.positions||[]).length} position(s)`});for(let e of t.fills||[])r.push({id:e.id,ts:e.at,agent:`city_market_watch`,kind:`trade`,msg:`${e.side===`sell`?`SOLD`:`BOUGHT`} ${e.ticker} ${e.qty?`${e.qty} sh `:``}@ $${e.price??`?`}`});r.sort((e,t)=>new Date(t.ts)-new Date(e.ts))}return{now:new Date().toISOString(),market:n,mode:`static`,agents:e.map(e=>({...e,status:Id(e,n)?`active`:`dark`,lastSeen:null,msg:null,kind:null,runsToday:0,running:!1})),portfolio:t?.portfolio?{...t.portfolio,ts:t.ts,by:`city_market_watch`}:null,recent:r.slice(0,60)}}var Rd=()=>Ed()?jd(`/city/state`):Ld(),zd=(e,t=40)=>Ed()?jd(`/city/events?limit=${t}${e?`&agent=${encodeURIComponent(e)}`:``}`):Ld().then(n=>({events:n.recent.filter(t=>!e||t.agent===e).slice(0,t)})),Bd=(e,t)=>Ed()?jd(`/city/chat`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({agent:e,message:t})}):Promise.reject(Error(`Chat needs the desktop bridge running — this is the hosted copy.`)),Vd=e=>document.querySelector(e),$=(e,t,n)=>{let r=document.createElement(e);return t&&(r.className=t),n!=null&&(r.textContent=n),r},Hd={trading:`TRADING TOWER`,hub:`HUB HQ`,studio:`DICTAFLOW STUDIO`,factory:`FACTORY`,other:`OUTSKIRTS`},Ud=new Map,Wd=null,Gd=()=>{};function Kd({onSelect:e}){return Gd=e,Vd(`#panel-close`).addEventListener(`click`,pf),document.addEventListener(`keydown`,e=>{e.key===`Escape`&&pf()}),{renderRoster:nf,openPanel:rf,closePanel:pf,setMarket:Zd,setClock:Qd,setLink:$d,setTicker:tf,get selected(){return Wd}}}function qd(e){return e?new Date(e).toLocaleTimeString([],{hour:`2-digit`,minute:`2-digit`}):`--`}function Jd(e){if(!e)return`--`;let t=new Date(e),n=qd(e),r=new Date;if(r.setHours(0,0,0,0),t>=r)return n;let i=new Date(r);return i.setDate(i.getDate()-1),t>=i?`Yst ${n}`:`${t.toLocaleDateString([],{month:`short`,day:`numeric`})} ${n}`}function Yd(e){if(!e)return`never`;let t=(Date.now()-new Date(e).getTime())/1e3;return t<60?`${Math.round(t)}s ago`:t<3600?`${Math.round(t/60)}m ago`:t<86400?`${Math.round(t/3600)}h ago`:`${Math.round(t/86400)}d ago`}var Xd=e=>typeof e==`number`?`$${e.toFixed(2)}`:`--`;function Zd(e){let t=Vd(`#market`);t.textContent={open:`MARKET OPEN`,premarket:`PRE-MARKET`,afterhours:`AFTER HOURS`,closed:e?.weekend?`WEEKEND`:`MARKET CLOSED`}[e?.phase]||`--`,t.classList.toggle(`live`,e?.phase===`open`)}function Qd(e){Vd(`#clock`).textContent=`${e} ET`}function $d(e){Vd(`#link`).classList.toggle(`ok`,!!e)}var ef=34;function tf(e){let t=Vd(`#ticker-track`),n=[];if(e.portfolio){let t=e.portfolio;n.push(`<b>ACCOUNT</b> ${Xd(t.totalValue)}`),typeof t.cash==`number`&&n.push(`<b>CASH</b> ${Xd(t.cash)}`);for(let e of t.positions||[]){let t=typeof e.plPct==`number`?`${e.plPct>0?`+`:``}${e.plPct.toFixed(2)}%`:``;n.push(`<b>${e.ticker}</b> ${Xd(e.current??e.price)} ${t}`)}n.push(`<b>SNAPSHOT</b> ${Yd(t.ts)}`)}else n.push(`<b>ACCOUNT</b> no snapshot reported yet`);for(let t of(e.recent||[]).slice(0,8))n.push(`<b>${t.agent}</b> ${t.msg||t.kind}`);t.innerHTML=n.concat(n).map(e=>`<span>${e}</span>`).join(``),requestAnimationFrame(()=>{let e=t.scrollWidth/2;t.style.animationDuration=`${Math.max(45,e/ef)}s`})}function nf(e){let t=Vd(`#roster-list`),n={};for(let t of e.agents)(n[t.district]||=[]).push(t),sf.set(t.id,t.name||t.id);t.innerHTML=``;for(let[e,r]of Object.entries(n)){let n=$(`div`,`rgroup`);n.append($(`div`,`rgroup-name`,Hd[e]||e.toUpperCase()));for(let e of r){let t=$(`div`,`ritem`+(e.id===Wd?` sel`:``));t.append($(`i`,`s ${e.status}`)),t.append($(`span`,`t`,e.name)),e.at&&t.append($(`span`,`at`,e.at)),t.addEventListener(`click`,()=>Gd(e.id)),n.append(t)}t.append(n)}}async function rf(e,t){Wd=e;let n=t.agents.find(t=>t.id===e);if(!n)return;Vd(`#panel`).classList.remove(`closed`),nf(t);let r=Vd(`#panel-body`);r.innerHTML=``,r.append($(`div`,`p-name`,n.name)),r.append($(`div`,`p-sub`,`${Hd[n.district]||n.district}${n.at?` · shift ${n.at} ET`:``}`)),r.append($(`div`,`p-role`,n.role||``));let i=$(`div`);i.append(af(`Status`,n.status.toUpperCase())),i.append(af(`Last seen`,Yd(n.lastSeen))),i.append(af(`Runs today`,String(n.runsToday??0))),n.msg&&i.append(af(`Last said`,n.msg)),r.append(i),n.district===`trading`&&r.append(lf(t.portfolio)),r.append($(`div`,`p-sec`,`ACTIVITY`));let a=$(`div`);a.append($(`div`,`empty`,`loading…`)),r.append(a);try{let{events:t}=await zd(e,25);a.innerHTML=``,t.length||a.append($(`div`,`empty`,n.at?`No runs recorded yet. Its sessions appear here once it commits to the trading repo.`:`nothing reported yet`));for(let e of t)a.append(of(e))}catch{a.innerHTML=``,a.append($(`div`,`empty`,`could not load activity`))}let o=$(`div`,`p-sec sec-toggle`,`CITY ACTIVITY`),s=$(`div`,`sec-body`);r.append(o,s),o.addEventListener(`click`,()=>{let e=s.classList.toggle(`open`);o.classList.toggle(`expanded`,e)});try{let{events:e}=await zd(null,30);o.textContent=`CITY ACTIVITY (${e.length})`,e.length||s.append($(`div`,`empty`,`quiet`));for(let t of e)s.append(of(t,!0))}catch{s.append($(`div`,`empty`,`could not load city activity`))}r.append(uf(e))}function af(e,t){let n=$(`div`,`kv`);return n.append($(`b`,null,e),$(`span`,null,t)),n}function of(e,t=!1){let n=$(`div`,`ev`),r=$(`time`,null,Jd(e.ts));r.title=new Date(e.ts).toLocaleString();let i=t?`${sf.get(e.agent)||e.agent} · `:``;return n.append(r,$(`span`,null,`${i}${e.msg||`[${e.kind}]`}`)),n}var sf=new Map;function cf(e){let t=$(`div`);if(t.append(af(`Entry`,Xd(e.entry))),t.append(af(`Current`,Xd(e.current??e.price))),t.append(af(`Stop-loss`,e.stop==null?`not set`:Xd(e.stop))),t.append(af(`Take-profit`,e.target==null?`not set`:Xd(e.target))),e.catalyst&&t.append(af(`Catalyst`,e.catalyst)),e.shares!=null&&e.entry!=null){let n=e.current??e.price;typeof n==`number`&&(t.append(af(`Value`,Xd(e.shares*n))),t.append(af(`P/L`,Xd(e.shares*(n-e.entry)))))}let n=e.current??e.price;if(e.stop!=null&&e.target!=null&&typeof n==`number`&&e.target>e.stop){let r=Math.min(1,Math.max(0,(n-e.stop)/(e.target-e.stop))),i=$(`div`,`gauge`),a=$(`div`,`gauge-fill`);a.style.width=`${(r*100).toFixed(1)}%`,i.append(a);let o=$(`div`,`gauge-ends`);o.append($(`span`,`down`,Xd(e.stop)),$(`span`,`up`,Xd(e.target))),t.append(i,o);let s=(n-e.stop)/n*100,c=(e.target-n)/n*100;t.append(af(`Room`,`${s.toFixed(1)}% to stop · ${c.toFixed(1)}% to target`))}return t}function lf(e){let t=$(`div`);if(t.append($(`div`,`p-sec`,`ACCOUNT`)),!e)return t.append($(`div`,`empty`,`No snapshot reported yet. An agent posts one at the end of each run.`)),t;t.append(af(`Total value`,Xd(e.totalValue))),t.append(af(`Cash`,Xd(e.cash))),t.append(af(`As of`,`${Yd(e.ts)} (${e.by||`unknown`})`));let n=e.positions||[];if(t.append($(`div`,`p-sec`,`POSITIONS (${n.length})`)),!n.length)t.append($(`div`,`empty`,`100% cash — no open positions`));else for(let e of n){let n=$(`div`,`pos pos-click`),r=$(`span`);r.append($(`span`,`tk`,e.ticker)),e.shares!=null&&r.append(document.createTextNode(` ${e.shares} sh`));let i=typeof e.plPct==`number`?e.plPct:null,a=$(`span`,i==null?``:i>=0?`up`:`down`,`${Xd(e.current??e.price)}${i==null?``:`  ${i>0?`+`:``}${i.toFixed(2)}%`}`);n.append(r,a),t.append(n);let o=$(`div`,`pos-detail`);o.append(cf(e)),t.append(o),n.addEventListener(`click`,()=>{let e=o.classList.toggle(`open`);n.classList.toggle(`expanded`,e)})}return t}function uf(e){let t=$(`div`);if(t.append($(`div`,`p-sec`,`TALK TO THIS AGENT`)),!Ed())return t.append($(`div`,`empty`,`Chat needs the desktop bridge. Open this same link while your laptop is awake and it unlocks automatically.`)),t;let n=$(`div`,`chat-log`),r=Ud.get(e)||[];for(let e of r)n.append(df(e.role,e.text));t.append(n);let i=$(`form`,`chat-form`),a=$(`input`);a.placeholder=`ask about its shift…`,a.autocomplete=`off`;let o=$(`button`,null,`send`);return o.type=`submit`,i.append(a,o),t.append(i),i.addEventListener(`submit`,async t=>{t.preventDefault();let r=a.value.trim();if(!r)return;a.value=``,o.disabled=!0,ff(e,`me`,r),n.append(df(`me`,r));let i=df(`pending`,`thinking…`);n.append(i),n.scrollIntoView({block:`end`});try{let t=await Bd(e,r);i.remove();let a=t.reply||`(no reply)`;ff(e,`them`,a),n.append(df(`them`,a))}catch(e){i.remove(),n.append(df(`err`,`agent unreachable: ${e.message}`))}finally{o.disabled=!1,a.focus(),n.lastChild?.scrollIntoView({block:`end`})}}),t}function df(e,t){return $(`div`,e===`me`?`msg me`:e===`err`?`msg err`:e===`pending`?`msg them pending`:`msg them`,t)}function ff(e,t,n){let r=Ud.get(e)||[];r.push({role:t,text:n}),Ud.set(e,r)}function pf(){Wd=null,Vd(`#panel`).classList.add(`closed`),document.querySelectorAll(`.ritem.sel`).forEach(e=>e.classList.remove(`sel`))}var mf=5e3,{scene:hf,camera:gf,renderer:_f,controls:vf,composer:yf}=Du(document.querySelector(`#scene`)),bf=null,xf=new Map,Sf=new Map,Cf=[],wf=null,Tf=null,Ef=null,Df=null,Of=Kd({onSelect:e=>Pf(e)}),kf=document.createElement(`div`);kf.id=`fly-hint`,kf.textContent=`F — fly`,document.body.appendChild(kf);var Af=Ou(gf,vf,_f.domElement,e=>{kf.textContent=e?`WASD move · Space/Shift up-down · RShift boost · Esc exit`:`F — fly`,kf.classList.toggle(`on`,e)});async function jf(){await Ad();try{bf=await Rd()}catch(e){document.querySelector(`#boot`).textContent=Ed()?`BRIDGE OFFLINE — start C:/dev/hub/pipeline/server.js`:`NO DATA — city-state.json unreachable`,console.error(e);return}Ju(hf),td(hf);let e=bf.agents.filter(e=>e.district===`trading`&&e.type!==`service`),t=bf.agents.filter(t=>!e.includes(t));Tf=Xu(hf,e);for(let[e,t]of Tf.floors)xf.set(e,t),Sf.set(e,new K(0,t.y,0));let n=$u(hf,t);for(let[e,t]of n)xf.set(e,t),Sf.set(e,t.group.position.clone().setY(t.height));Cf=sd(hf,e),wf=pd(hf),qu();let r=Tf.topY+12;if(vf.target.set(0,r*.42,0),gf.position.set(r*1.15,r*.78,r*1.3),vf.maxDistance=Math.max(260,r*3),vf.update(),Df=new X(new ta(11,12.4,48),new ni({color:Eu,transparent:!0,opacity:.6,side:2})),Df.rotation.x=-Math.PI/2,Df.position.y=.1,Df.visible=!1,hf.add(Df),Nf(bf),document.querySelector(`#boot`).classList.add(`gone`),xd){let e=document.createElement(`button`);e.id=`token-btn`,e.textContent=`bridge found — unlock`,e.title=`Paste the token from C:\\dev\\hub\\pipeline\\.bridge-token`,e.onclick=()=>{let e=prompt(`Bridge token (pipeline/.bridge-token):`);e&&Sd(e)},document.querySelector(`#topbar`).appendChild(e)}setInterval(Mf,mf),zf()}async function Mf(){try{let e=await Rd();Of.setLink(!0),Nf(e)}catch{Of.setLink(!1)}}function Nf(e){if(xf.size&&e.agents.some(e=>!xf.has(e.id))){window.location.reload();return}bf=e,Of.setMarket(e.market),Of.setClock(e.market?.etTime||`--:--`),Of.setTicker(e),Of.renderRoster(e),Of.setLink(!0);for(let t of e.agents){rd(xf.get(t.id),t.status);let e=Cf.find(e=>e.agent.id===t.id);e&&(e.status=t.status)}let t=e.recent||[];if(t.length){let e=t[0].id;if(Ef&&e!==Ef){let e=t.findIndex(e=>e.id===Ef),n=e===-1?t.slice(0,5):t.slice(0,e);for(let e of n.reverse()){let t=Sf.get(e.agent);if(!t)continue;let n=new K(0,Tf.topY+6,0);wf.fire(t,n,e.kind===`error`?16736086:Eu)}}Ef=e}}function Pf(e){Of.openPanel(e,bf);let t=Sf.get(e);if(t){ku(gf,vf,t.clone(),e.startsWith(`robinhood`)?52:40,8);let n=xf.get(e);Df.visible=!0,Df.position.set(n.group?n.group.position.x:0,.1,n.group?n.group.position.z:0)}}var Ff=new vo,If=new G,Lf=null;_f.domElement.addEventListener(`pointerdown`,e=>{Lf={x:e.clientX,y:e.clientY}}),_f.domElement.addEventListener(`pointerup`,e=>{if(!Lf||Math.hypot(e.clientX-Lf.x,e.clientY-Lf.y)>6)return;let t=_f.domElement.getBoundingClientRect();If.x=(e.clientX-t.left)/t.width*2-1,If.y=-((e.clientY-t.top)/t.height)*2+1,Ff.setFromCamera(If,gf);let n=Ff.intersectObjects(hf.children,!0);for(let e of n){let t=e.object.userData?.agentId;if(t){Pf(t);return}}});var Rf=new xo;function zf(){requestAnimationFrame(zf),Bf(Math.min(Rf.getDelta(),.1),Rf.elapsedTime)}function Bf(e,t){for(let n of xf.values())id(n,e,t);if(fd(Cf,e,t),wf.update(e),Tf){let n=.6+Math.abs(Math.sin(t*1.6))*.4;Tf.beacon.material.color.setRGB(n,1,1),Tf.beacon.scale.setScalar(.9+n*.25),bf?.market?.phase===`open`&&(Tf.ring.rotation.z+=e*.5)}Df?.visible&&(Df.material.opacity=.35+Math.sin(t*3)*.2,Df.rotation.z+=e*.3),Af.update(e),Af.active||vf.update(),yf.render(),Vf++}var Vf=0;window.__city={get scene(){return hf},camera:gf,renderer:_f,controls:vf,composer:yf,get state(){return bf},get frames(){return Vf},get citizens(){return Cf},get tower(){return Tf},fly:Af,entries:xf,anchors:Sf,select:Pf,step:Bf},jf();