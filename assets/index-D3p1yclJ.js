...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function ts(e,t,n){let r=new Float32Array(Vo),i=new K(0,1,0);return new pa({name:`SphericalGaussianBlur`,defines:{n:Vo,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:is(),fragmentShader:`
	...
	`}var as=class extends Gt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new qi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
	...
	if ( coord.x >= 1.0 ) {
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}};wu.BlurDirectionX=new G(1,0),wu.BlurDirectionY=new G(0,1);var Tu={name:`OutputShader`,uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
		precision highp float;
		...
		}`},Eu=class extends mu{constructor(){super(),this.isOutputPass=!0,this.uniforms=ua.clone(Tu.uniforms),this.material=new ma({name:Tu.name,uniforms:this.uniforms,vertexShader:Tu.vertexShader,fragmentShader:Tu.fragmentShader}),this._fsQuad=new _u(this.material),this._outputColorSpace=null,this._toneMapping=null}render(e,t,n){this.uniforms.tDiffuse.value=n.texture,this.uniforms.toneMappingExposure.value=e.toneMappingExposure,(this._outputColorSpace!==e.outputColorSpace||this._toneMapping!==e.toneMapping)&&(this._outputColorSpace=e.outputColorSpace,this._toneMapping=e.toneMapping,this.material.defines={},J.getTransfer(this._outputColorSpace)===`srgb`&&(this.material.defines.SRGB_TRANSFER=``),this._toneMapping===1?this.material.defines.LINEAR_TONE_MAPPING=``:this._toneMapping===2?this.material.defines.REINHARD_TONE_MAPPING=``:this._toneMapping===3?this.material.defines.CINEON_TONE_MAPPING=``:this._toneMapping===4?this.material.defines.ACES_FILMIC_TONE_MAPPING=``:this._toneMapping===6?this.material.defines.AGX_TONE_MAPPING=``:this._toneMapping===7?this.material.defines.NEUTRAL_TONE_MAPPING=``:this._toneMapping===5&&(this.material.defines.CUSTOM_TONE_MAPPING=``),this.material.needsUpdate=!0),this.renderToScreen===!0?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},Du=58879;function Ou(e){let t=new Mn;t.background=new Y(395273),t.fog=new jn(395273,.0085);let n=new Ka(52,window.innerWidth/window.innerHeight,.5,2e3);n.position.set(78,52,88);let r=new Ul({canvas:e,antialias:!0,powerPreference:`high-performance`});r.setSize(window.innerWidth||1,window.innerHeight||1,!1),r.setPixelRatio(Math.min(window.devicePixelRatio,1.25)),r.toneMapping=4,r.toneMappingExposure=1.05;let i=new eu(n,r.domElement);i.enableDamping=!0,i.dampingFactor=.06,i.maxPolarAngle=Math.PI*.487,i.minDistance=18,i.maxDistance=260,i.target.set(0,14,0),t.add(new Qa(2240568,.55));let a=new Za(10476520,.35);a.position.set(-60,90,40),t.add(a);let o=new Ja(Du,60,220,2);o.position.set(0,6,0),t.add(o);let s=new xu(r);s.addPass(new Su(t,n));let c=.5,l=new wu(new G(window.innerWidth*c,window.innerHeight*c),.85,.7,.22);s.addPass(l),s.addPass(new Eu);function u(){let t=e.clientWidth||window.innerWidth||1,i=e.clientHeight||window.innerHeight||1;n.aspect=t/i,n.updateProjectionMatrix(),r.setSize(t,i,!1),s.setSize(t,i),l.setSize(t*c,i*c)}return window.addEventListener(`resize`,u),new ResizeObserver(u).observe(e),{scene:t,camera:n,renderer:r,controls:i,composer:s,bloom:l,resize:u}}function ku(e,t,n,r=46,i=22){let a=e.position.clone(),o=t.target.clone(),s=a.clone().sub(o).setY(0).normalize(),c=n.clone().add(s.multiplyScalar(r)).setY(n.y+i),l=performance.now();function u(r){let i=Math.min((r-l)/900,1),s=i<.5?4*i*i*i:1-(-2*i+2)**3/2;e.position.lerpVectors(a,c,s),t.target.lerpVectors(o,n,s),t.update(),i<1&&requestAnimationFrame(u)}requestAnimationFrame(u)}var Au=new Y(Du),ju=new Map;function Mu(e,t,n,r){let i=`${e}x${t}:${n}:${r}`,a=ju.get(i);return a||(a=Nu(e,t,n,r*7+3),ju.set(i,a)),a}function Nu(e=6,t=10,n=.55,r=1){let i=document.createElement(`canvas`);i.width=e*8,i.height=t*8;let o=i.getContext(`2d`);o.fillStyle=`#000`,o.fillRect(0,0,i.width,i.height);let s=r*9301,c=()=>(s=(s*9301+49297)%233280)/233280;for(let r=0;r<t;r++)for(let t=0;t<e;t++){if(c()>n)continue;let e=c();o.fillStyle=e>.82?`#bff9ff`:e>.4?`#00e5ff`:`#0a8fa3`,o.fillRect(t*8+3/2,r*8+3/2,5,5)}let l=new Ji(i);return l.magFilter=a,l.minFilter=u,l.colorSpace=Re,l}function Pu(e,{size:t=128,color:n=`#00e5ff`,width:r=10}={}){let i=document.createElement(`canvas`);i.width=512,i.height=128;let a=i.getContext(`2d`);a.fillStyle=n,a.font=`600 ${t*.52}px ui-monospace, Consolas, monospace`,a.textAlign=`center`,a.textBaseline=`middle`,a.shadowColor=n,a.shadowBlur=18,a.fillText(e,i.width/2,i.height/2);let o=new Ji(i);o.colorSpace=Re;let s=new Gr(new jr({map:o,transparent:!0,depthWrite:!1}));return s.scale.set(r,r/4,1),s}function Fu(e){let t=new Cn,n=new pi(new ta(600,600),new ha({color:461581,roughness:.72,metalness:.25}));n.rotation.x=-Math.PI/2,n.position.y=-.02,t.add(n);let r=new wo(600,60,Du,666161);r.material.transparent=!0,r.material.opacity=.16,t.add(r);let i=new ti({color:Du,transparent:!0,opacity:.13});for(let e of[0,Math.PI/2]){let n=new pi(new ta(600,9),i);n.rotation.x=-Math.PI/2,n.rotation.z=e,n.position.y=.02,t.add(n)}return e.add(t),t}function Iu({w:e,h:t,d:n,cols:r,rows:i,litChance:a,seed:o,color:s=791576}){let c=new ha({color:s,roughness:.55,metalness:.5,emissive:Au.clone(),emissiveMap:Nu(r,i,a,o),emissiveIntensity:.9});return new pi(new Qi(e,t,n),c)}function Lu(e,t){let n=new Cn;n.position.set(0,0,0);let r=new Map,i=new pi(new Qi(22,2,22),new ha({color:659990,roughness:.6,metalness:.6}));i.position.y=1,n.add(i);let a=e=>{let[t,n]=String(e).split(`:`).map(Number);return t*60+(n||0)},o=t.filter(e=>e.type!==`weekly`).sort((e,t)=>a(e.at||`99:99`)-a(t.at||`99:99`)),s=t.filter(e=>e.type===`weekly`),c=[...o,...s];c.forEach((e,t)=>{let i=2+7*t+7/2,a=Math.max(.55,1-t*.035),o=e.type===`weekly`?new pi(new Qi(16*a+2,6.5,16*a+2),new ha({color:926249,roughness:.15,metalness:.85,emissive:Au.clone(),emissiveIntensity:.5,transparent:!0,opacity:.92})):Iu({w:16*a,h:6.5,d:16*a,cols:7,rows:5,litChance:.6,seed:t+3});o.position.y=i,o.userData.agentId=e.id,o.userData.kind=`floor`,n.add(o);let s=new pi(new Qi(16*a+.6,.3,16*a+.6),new ti({color:Du,transparent:!0,opacity:.35}));s.position.y=i+7/2-.25,n.add(s);let c=Pu(e.at||(e.type===`weekly`?`WEEKLY`:e.name),{width:12});c.position.set(0,i,16*a/2+2.2),n.add(c),r.set(e.id,{mesh:o,mat:o.material,light:null,band:s,label:c,y:i})});let l=2+7*c.length,u=new pi(new ea(2.2,5.5,5,6),new ha({color:793120,metalness:.8,roughness:.3,emissive:Au.clone(),emissiveIntensity:.25}));u.position.y=l+2.5,n.add(u);let d=new pi(new ra(1.1,16,16),new ti({color:12581375}));d.position.y=l+6,n.add(d);let f=new pi(new ia(13,.22,8,64),new ti({color:Du,transparent:!0,opacity:.55}));f.rotation.x=Math.PI/2,f.position.y=l+1,n.add(f);let p=Pu(`TRADING TOWER`,{width:26});return p.position.set(0,l+10,0),n.add(p),e.add(n),{group:n,floors:r,beacon:d,ring:f,topY:l}}var Ru={hub:{pos:[-46,0,-20],w:26,h:13,d:20,label:`HUB HQ`,cols:10,rows:4},studio:{pos:[40,0,-30],w:11,h:26,d:11,label:`STUDIO`,cols:5,rows:9},factory:{pos:[-34,0,40],w:30,h:10,d:22,label:`FACTORY`,cols:12,rows:3}},zu=[[34,0,24],[52,0,38],[34,0,52],[62,0,14],[76,0,44],[48,0,68]];function Bu(e,t){let n=new Map,r=0;for(let i of t){let t=Ru[i.district]||{pos:zu[r++%zu.length],w:12,h:9+i.id.length%5*2,d:12,label:(i.name||i.id).toUpperCase().slice(0,14),cols:5,rows:4},a=new Cn;a.position.set(...t.pos);let o=Iu({w:t.w,h:t.h,d:t.d,cols:t.cols,rows:t.rows,litChance:.42,seed:t.label.length+7});o.position.y=t.h/2,o.userData.agentId=i.id,o.userData.kind=`building`,a.add(o);let s=Pu(t.label,{width:18});if(s.position.set(0,t.h+5,0),a.add(s),i.district===`studio`){let e=new pi(new ea(.22,.22,14,6),new ti({color:Du}));e.position.y=t.h+7,a.add(e)}if(i.district===`factory`)for(let e of[-9,0,9]){let n=new pi(new ea(1.5,1.9,12,10),new ha({color:659990,metalness:.6,roughness:.5}));n.position.set(e,t.h+6,-4),a.add(n)}e.add(a),n.set(i.id,{group:a,mesh:o,mat:o.material,light:null,label:s,height:t.h})}return n}var Vu=4;function Hu(e,t=90){let n=new Cn,r=new Qi(1,1,1),i=11,a=()=>(i=(i*9301+49297)%233280)/233280,o=Array.from({length:Vu},()=>[]),s=new Jt;for(let e=0;e<t;e++){let t=a()*Math.PI*2,n=62+a()*150,r=6+a()*46,i=6+a()*11;s.makeScale(i,r,i),s.setPosition(Math.cos(t)*n,r/2,Math.sin(t)*n),o[e%Vu].push(s.clone())}return o.forEach((e,t)=>{let i=new ha({color:791576,roughness:.55,metalness:.5,emissive:Au.clone(),emissiveMap:Mu(5,9,.18+t*.06,t),emissiveIntensity:.45}),a=new Ti(r,i,e.length);e.forEach((e,t)=>a.setMatrixAt(t,e)),a.instanceMatrix.needsUpdate=!0,a.frustumCulled=!1,n.add(a)}),e.add(n),n}var Uu={active:{emissive:2.1,light:30,opacity:.95},idle:{emissive:.85,light:6,opacity:.45},dark:{emissive:.32,light:0,opacity:.18},error:{emissive:1.6,light:20,opacity:.9,color:16736086}};function Wu(e,t){if(!e)return;let n=Uu[t]||Uu.dark;e.targetEmissive=n.emissive,e.targetLight=n.light;let r=n.color?new Y(n.color):Au;e.mat.emissive.copy(r),e.light&&e.light.color.copy(r),e.band&&(e.band.material.opacity=n.opacity),e.label&&(e.label.material.opacity=t===`dark`?.35:1)}function Gu(e,t){if(e.targetEmissive==null)return;let n=Math.min(t*3,1);e.mat.emissiveIntensity+=(e.targetEmissive-e.mat.emissiveIntensity)*n,e.light&&(e.light.intensity+=(e.targetLight-e.light.intensity)*n)}var Ku=new Y(Du),qu=new $i(.5,1.5,4,8);function Ju(){let e=new Cn,t=new pi(qu,new ha({color:859170,metalness:.4,roughness:.4,emissive:Ku.clone(),emissiveIntensity:1.4}));t.position.y=1.3,e.add(t);let n=new Gr(new jr({color:Du,transparent:!0,opacity:.5,depthWrite:!1,blending:2}));return n.scale.set(4,4,1),n.position.y=1.4,e.add(n),{group:e,body:t,halo:n}}function Yu(e,t){let n=[];return t.forEach((r,i)=>{let a=Ju(),o=24+i%4*4.5,s=i/t.length*Math.PI*2;a.group.position.set(Math.cos(s)*o,0,Math.sin(s)*o),e.add(a.group),n.push({...a,agent:r,radius:o,angle:s,speed:.12+i%3*.045,status:`dark`})}),n}function Xu(e,t,n){for(let r of e){let e=r.status===`active`,i=r.status!==`dark`;if(r.group.visible=i,!i)continue;e&&(r.angle+=r.speed*t);let a=Math.cos(r.angle)*r.radius,o=Math.sin(r.angle)*r.radius;r.group.position.x+=(a-r.group.position.x)*Math.min(t*2,1),r.group.position.z+=(o-r.group.position.z)*Math.min(t*2,1),r.group.rotation.y=-r.angle+Math.PI/2,r.body.position.y=1.3+(e?Math.sin(n*6+r.angle*3)*.09:0);let s=e?1.8:.5;r.body.material.emissiveIntensity+=(s-r.body.material.emissiveIntensity)*Math.min(t*3,1),r.halo.material.opacity=e?.45+Math.sin(n*3+r.angle)*.12:.14}}function Zu(e,t=18){let n=new ra(.55,8,8),r=[];for(let i=0;i<t;i++){let t=new pi(n,new ti({color:Du,transparent:!0,opacity:0,blending:2,depthWrite:!1}));t.visible=!1,e.add(t),r.push({mesh:t,t:1,from:new K,to:new K,dur:1})}return{fire(e,t,n=Du){let i=r.find(e=>e.t>=1);i&&(i.from.copy(e),i.to.copy(t),i.t=0,i.dur=.7+e.distanceTo(t)/90,i.mesh.material.color.set(n),i.mesh.visible=!0)},update(e){for(let t of r){if(t.t>=1)continue;t.t=Math.min(t.t+e/t.dur,1);let n=t.t;t.mesh.position.lerpVectors(t.from,t.to,n),t.mesh.position.y+=Math.sin(n*Math.PI)*12,t.mesh.material.opacity=Math.sin(n*Math.PI)*.95,t.t>=1&&(t.mesh.visible=!1)}}}}var Qu=`http://127.0.0.1:8787`,$u=`https://raw.githubusercontent.com/AztecNightmare365/claude-trading-tasks/main/city-state.json`,ed=`./roster.json`,td=typeof window<`u`?window.__HUB_TOKEN:null,nd=typeof window<`u`&&!!window.__HUB_REMOTE,rd=null,id=`unknown`,ad=()=>id===`bridge`;function od(e={}){let t={...e};return td&&(t.Authorization=`Bearer ${td}`),t}async function sd(e,t=1500){try{let n=new AbortController,r=setTimeout(()=>n.abort(),t),i=await fetch(`${e}/health`,{headers:od(),signal:n.signal});return clearTimeout(r),i.ok?!!(await i.json()).bridge:!1}catch{return!1}}async function cd(){return nd&&await sd(``)?(rd=``,id=`bridge`,id):await sd(Qu)?(rd=Qu,id=`bridge`,id):(rd=null,id=`static`,id)}async function ld(e,t={}){if(rd===null)throw Error(`no bridge`);let n=await fetch(rd+e,{...t,headers:od(t.headers)});if(!n.ok)throw Error(`${e} -> ${n.status}`);return n.json()}var ud=null;async function dd(){return ud||(ud=(await(await fetch(ed,{cache:`no-cache`})).json()).agents||[],ud)}function fd(){let e=new Date(new Date().toLocaleString(`en-US`,{timeZone:`America/New_York`})),t=e.getHours()*60+e.getMinutes(),n=e.getDay(),r=n===0||n===6,i=`closed`;return r||(t>=570&&t<960?i=`open`:t>=240&&t<570?i=`premarket`:t>=960&&t<1200&&(i=`afterhours`)),{phase:i,weekend:r,etTime:`${String(e.getHours()).padStart(2,`0`)}:${String(e.getMinutes()).padStart(2,`0`)}`}}var pd=20;function md(e,t){if(!e.at||t.weekend)return!1;let[n,r]=e.at.split(`:`).map(Number),[i,a]=t.etTime.split(`:`).map(Number),o=n*60+r,s=i*60+a;return s>=o&&s<o+pd}async function hd(){let[e,t]=await Promise.all([dd(),fetch(`${$u}?t=${Date.now()}`,{cache:`no-store`}).then(e=>e.ok?e.json():null).catch(()=>null)]),n=fd(),r=[];if(t){t.portfolio&&r.push({id:`snap`,ts:t.ts,agent:`city_market_watch`,kind:`snapshot`,msg:`account $${Number(t.portfolio.totalValue).toFixed(2)} - ${(t.portfolio.positions||[]).length} position(s)`});for(let e of t.fills||[])r.push({id:e.id,ts:e.at,agent:`city_market_watch`,kind:`trade`,msg:`${e.side===`sell`?`SOLD`:`BOUGHT`} ${e.ticker} ${e.qty?`${e.qty} sh `:``}@ $${e.price??`?`}`});r.sort((e,t)=>new Date(t.ts)-new Date(e.ts))}return{now:new Date().toISOString(),market:n,mode:`static`,agents:e.map(e=>({...e,status:md(e,n)?`active`:`dark`,lastSeen:null,msg:null,kind:null,runsToday:0,running:!1})),portfolio:t?.portfolio?{...t.portfolio,ts:t.ts,by:`city_market_watch`}:null,recent:r.slice(0,60)}}var gd=()=>ad()?ld(`/city/state`):hd(),_d=(e,t=40)=>ad()?ld(`/city/events?limit=${t}${e?`&agent=${encodeURIComponent(e)}`:``}`):hd().then(n=>({events:n.recent.filter(t=>!e||t.agent===e).slice(0,t)})),vd=(e,t)=>ad()?ld(`/city/chat`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({agent:e,message:t})}):Promise.reject(Error(`Chat needs the desktop bridge running — this is the hosted copy.`)),yd=e=>document.querySelector(e),$=(e,t,n)=>{let r=document.createElement(e);return t&&(r.className=t),n!=null&&(r.textContent=n),r},bd={trading:`TRADING TOWER`,hub:`HUB HQ`,studio:`DICTAFLOW STUDIO`,factory:`FACTORY`,other:`OUTSKIRTS`},xd=new Map,Sd=null,Cd=()=>{};function wd({onSelect:e}){return Cd=e,yd(`#panel-close`).addEventListener(`click`,Wd),document.addEventListener(`keydown`,e=>{e.key===`Escape`&&Wd()}),{renderRoster:Pd,openPanel:Fd,closePanel:Wd,setMarket:kd,setClock:Ad,setLink:jd,setTicker:Nd,get selected(){return Sd}}}function Td(e){return e?new Date(e).toLocaleTimeString([],{hour:`2-digit`,minute:`2-digit`}):`--`}function Ed(e){if(!e)return`--`;let t=new Date(e),n=Td(e),r=new Date;if(r.setHours(0,0,0,0),t>=r)return n;let i=new Date(r);return i.setDate(i.getDate()-1),t>=i?`Yst ${n}`:`${t.toLocaleDateString([],{month:`short`,day:`numeric`})} ${n}`}function Dd(e){if(!e)return`never`;let t=(Date.now()-new Date(e).getTime())/1e3;return t<60?`${Math.round(t)}s ago`:t<3600?`${Math.round(t/60)}m ago`:t<86400?`${Math.round(t/3600)}h ago`:`${Math.round(t/86400)}d ago`}var Od=e=>typeof e==`number`?`$${e.toFixed(2)}`:`--`;function kd(e){let t=yd(`#market`);t.textContent={open:`MARKET OPEN`,premarket:`PRE-MARKET`,afterhours:`AFTER HOURS`,closed:e?.weekend?`WEEKEND`:`MARKET CLOSED`}[e?.phase]||`--`,t.classList.toggle(`live`,e?.phase===`open`)}function Ad(e){yd(`#clock`).textContent=`${e} ET`}function jd(e){yd(`#link`).classList.toggle(`ok`,!!e)}var Md=34;function Nd(e){let t=yd(`#ticker-track`),n=[];if(e.portfolio){let t=e.portfolio;n.push(`<b>ACCOUNT</b> ${Od(t.totalValue)}`),typeof t.cash==`number`&&n.push(`<b>CASH</b> ${Od(t.cash)}`);for(let e of t.positions||[]){let t=typeof e.plPct==`number`?`${e.plPct>0?`+`:``}${e.plPct.toFixed(2)}%`:``;n.push(`<b>${e.ticker}</b> ${Od(e.current??e.price)} ${t}`)}n.push(`<b>SNAPSHOT</b> ${Dd(t.ts)}`)}else n.push(`<b>ACCOUNT</b> no snapshot reported yet`);for(let t of(e.recent||[]).slice(0,8))n.push(`<b>${t.agent}</b> ${t.msg||t.kind}`);t.innerHTML=n.concat(n).map(e=>`<span>${e}</span>`).join(``),requestAnimationFrame(()=>{let e=t.scrollWidth/2;t.style.animationDuration=`${Math.max(45,e/Md)}s`})}function Pd(e){let t=yd(`#roster-list`),n={};for(let t of e.agents)(n[t.district]||=[]).push(t),Rd.set(t.id,t.name||t.id);t.innerHTML=``;for(let[e,r]of Object.entries(n)){let n=$(`div`,`rgroup`);n.append($(`div`,`rgroup-name`,bd[e]||e.toUpperCase()));for(let e of r){let t=$(`div`,`ritem`+(e.id===Sd?` sel`:``));t.append($(`i`,`s ${e.status}`)),t.append($(`span`,`t`,e.name)),e.at&&t.append($(`span`,`at`,e.at)),t.addEventListener(`click`,()=>Cd(e.id)),n.append(t)}t.append(n)}}async function Fd(e,t){Sd=e;let n=t.agents.find(t=>t.id===e);if(!n)return;yd(`#panel`).classList.remove(`closed`),Pd(t);let r=yd(`#panel-body`);r.innerHTML=``,r.append($(`div`,`p-name`,n.name)),r.append($(`div`,`p-sub`,`${bd[n.district]||n.district}${n.at?` · shift ${n.at} ET`:``}`)),r.append($(`div`,`p-role`,n.role||``));let i=$(`div`);i.append(Id(`Status`,n.status.toUpperCase())),i.append(Id(`Last seen`,Dd(n.lastSeen))),i.append(Id(`Runs today`,String(n.runsToday??0))),n.msg&&i.append(Id(`Last said`,n.msg)),r.append(i),n.district===`trading`&&r.append(Bd(t.portfolio)),r.append($(`div`,`p-sec`,`ACTIVITY`));let a=$(`div`);a.append($(`div`,`empty`,`loading…`)),r.append(a);try{let{events:t}=await _d(e,25);a.innerHTML=``,t.length||a.append($(`div`,`empty`,n.at?`No runs recorded yet. Its sessions appear here once it commits to the trading repo.`:`nothing reported yet`));for(let e of t)a.append(Ld(e))}catch{a.innerHTML=``,a.append($(`div`,`empty`,`could not load activity`))}let o=$(`div`,`p-sec sec-toggle`,`CITY ACTIVITY`),s=$(`div`,`sec-body`);r.append(o,s),o.addEventListener(`click`,()=>{let e=s.classList.toggle(`open`);o.classList.toggle(`expanded`,e)});try{let{events:e}=await _d(null,30);o.textContent=`CITY ACTIVITY (${e.length})`,e.length||s.append($(`div`,`empty`,`quiet`));for(let t of e)s.append(Ld(t,!0))}catch{s.append($(`div`,`empty`,`could not load city activity`))}r.append(Vd(e))}function Id(e,t){let n=$(`div`,`kv`);return n.append($(`b`,null,e),$(`span`,null,t)),n}function Ld(e,t=!1){let n=$(`div`,`ev`),r=$(`time`,null,Ed(e.ts));r.title=new Date(e.ts).toLocaleString();let i=t?`${Rd.get(e.agent)||e.agent} · `:``;return n.append(r,$(`span`,null,`${i}${e.msg||`[${e.kind}]`}`)),n}var Rd=new Map;function zd(e){let t=$(`div`);if(t.append(Id(`Entry`,Od(e.entry))),t.append(Id(`Current`,Od(e.current??e.price))),t.append(Id(`Stop-loss`,e.stop==null?`not set`:Od(e.stop))),t.append(Id(`Take-profit`,e.target==null?`not set`:Od(e.target))),e.catalyst&&t.append(Id(`Catalyst`,e.catalyst)),e.shares!=null&&e.entry!=null){let n=e.current??e.price;typeof n==`number`&&(t.append(Id(`Value`,Od(e.shares*n))),t.append(Id(`P/L`,Od(e.shares*(n-e.entry)))))}let n=e.current??e.price;if(e.stop!=null&&e.target!=null&&typeof n==`number`&&e.target>e.stop){let r=Math.min(1,Math.max(0,(n-e.stop)/(e.target-e.stop))),i=$(`div`,`gauge`),a=$(`div`,`gauge-fill`);a.style.width=`${(r*100).toFixed(1)}%`,i.append(a);let o=$(`div`,`gauge-ends`);o.append($(`span`,`down`,Od(e.stop)),$(`span`,`up`,Od(e.target))),t.append(i,o);let s=(n-e.stop)/n*100,c=(e.target-n)/n*100;t.append(Id(`Room`,`${s.toFixed(1)}% to stop · ${c.toFixed(1)}% to target`))}return t}function Bd(e){let t=$(`div`);if(t.append($(`div`,`p-sec`,`ACCOUNT`)),!e)return t.append($(`div`,`empty`,`No snapshot reported yet. An agent posts one at the end of each run.`)),t;t.append(Id(`Total value`,Od(e.totalValue))),t.append(Id(`Cash`,Od(e.cash))),t.append(Id(`As of`,`${Dd(e.ts)} (${e.by||`unknown`})`));let n=e.positions||[];if(t.append($(`div`,`p-sec`,`POSITIONS (${n.length})`)),!n.length)t.append($(`div`,`empty`,`100% cash — no open positions`));else for(let e of n){let n=$(`div`,`pos pos-click`),r=$(`span`);r.append($(`span`,`tk`,e.ticker)),e.shares!=null&&r.append(document.createTextNode(` ${e.shares} sh`));let i=typeof e.plPct==`number`?e.plPct:null,a=$(`span`,i==null?``:i>=0?`up`:`down`,`${Od(e.current??e.price)}${i==null?``:`  ${i>0?`+`:``}${i.toFixed(2)}%`}`);n.append(r,a),t.append(n);let o=$(`div`,`pos-detail`);o.append(zd(e)),t.append(o),n.addEventListener(`click`,()=>{let e=o.classList.toggle(`open`);n.classList.toggle(`expanded`,e)})}return t}function Vd(e){let t=$(`div`);if(t.append($(`div`,`p-sec`,`TALK TO THIS AGENT`)),!ad())return t.append($(`div`,`empty`,`Chat needs the desktop bridge. Open this same link while your laptop is awake and it unlocks automatically.`)),t;let n=$(`div`,`chat-log`),r=xd.get(e)||[];for(let e of r)n.append(Hd(e.role,e.text));t.append(n);let i=$(`form`,`chat-form`),a=$(`input`);a.placeholder=`ask about its shift…`,a.autocomplete=`off`;let o=$(`button`,null,`send`);return o.type=`submit`,i.append(a,o),t.append(i),i.addEventListener(`submit`,async t=>{t.preventDefault();let r=a.value.trim();if(!r)return;a.value=``,o.disabled=!0,Ud(e,`me`,r),n.append(Hd(`me`,r));let i=Hd(`pending`,`thinking…`);n.append(i),n.scrollIntoView({block:`end`});try{let t=await vd(e,r);i.remove();let a=t.reply||`(no reply)`;Ud(e,`them`,a),n.append(Hd(`them`,a))}catch(e){i.remove(),n.append(Hd(`err`,`agent unreachable: ${e.message}`))}finally{o.disabled=!1,a.focus(),n.lastChild?.scrollIntoView({block:`end`})}}),t}function Hd(e,t){return $(`div`,e===`me`?`msg me`:e===`err`?`msg err`:e===`pending`?`msg them pending`:`msg them`,t)}function Ud(e,t,n){let r=xd.get(e)||[];r.push({role:t,text:n}),xd.set(e,r)}function Wd(){Sd=null,yd(`#panel`).classList.add(`closed`),document.querySelectorAll(`.ritem.sel`).forEach(e=>e.classList.remove(`sel`))}var Gd=5e3,{scene:Kd,camera:qd,renderer:Jd,controls:Yd,composer:Xd}=Ou(document.querySelector(`#scene`)),Zd=null,Qd=new Map,$d=new Map,ef=[],tf=null,nf=null,rf=null,af=null,of=wd({onSelect:e=>uf(e)});async function sf(){await cd();try{Zd=await gd()}catch(e){document.querySelector(`#boot`).textContent=ad()?`BRIDGE OFFLINE — start C:/dev/hub/pipeline/server.js`:`NO DATA — city-state.json unreachable`,console.error(e);return}Fu(Kd),Hu(Kd);let e=Zd.agents.filter(e=>e.district===`trading`&&e.type!==`service`),t=Zd.agents.filter(t=>!e.includes(t));nf=Lu(Kd,e);for(let[e,t]of nf.floors)Qd.set(e,t),$d.set(e,new K(0,t.y,0));let n=Bu(Kd,t);for(let[e,t]of n)Qd.set(e,t),$d.set(e,t.group.position.clone().setY(t.height));ef=Yu(Kd,e),tf=Zu(Kd);let r=nf.topY+12;Yd.target.set(0,r*.42,0),qd.position.set(r*1.15,r*.78,r*1.3),Yd.maxDistance=Math.max(260,r*3),Yd.update(),af=new pi(new na(11,12.4,48),new ti({color:Du,transparent:!0,opacity:.6,side:2})),af.rotation.x=-Math.PI/2,af.position.y=.1,af.visible=!1,Kd.add(af),lf(Zd),document.querySelector(`#boot`).classList.add(`gone`),setInterval(cf,Gd),hf()}async function cf(){try{let e=await gd();of.setLink(!0),lf(e)}catch{of.setLink(!1)}}function lf(e){if(Qd.size&&e.agents.some(e=>!Qd.has(e.id))){window.location.reload();return}Zd=e,of.setMarket(e.market),of.setClock(e.market?.etTime||`--:--`),of.setTicker(e),of.renderRoster(e),of.setLink(!0);for(let t of e.agents){Wu(Qd.get(t.id),t.status);let e=ef.find(e=>e.agent.id===t.id);e&&(e.status=t.status)}let t=e.recent||[];if(t.length){let e=t[0].id;if(rf&&e!==rf){let e=t.findIndex(e=>e.id===rf),n=e===-1?t.slice(0,5):t.slice(0,e);for(let e of n.reverse()){let t=$d.get(e.agent);if(!t)continue;let n=new K(0,nf.topY+6,0);tf.fire(t,n,e.kind===`error`?16736086:Du)}}rf=e}}function uf(e){of.openPanel(e,Zd);let t=$d.get(e);if(t){ku(qd,Yd,t.clone(),e.startsWith(`robinhood`)?52:40,8);let n=Qd.get(e);af.visible=!0,af.position.set(n.group?n.group.position.x:0,.1,n.group?n.group.position.z:0)}}var df=new yo,ff=new G,pf=null;Jd.domElement.addEventListener(`pointerdown`,e=>{pf={x:e.clientX,y:e.clientY}}),Jd.domElement.addEventListener(`pointerup`,e=>{if(!pf||Math.hypot(e.clientX-pf.x,e.clientY-pf.y)>6)return;let t=Jd.domElement.getBoundingClientRect();ff.x=(e.clientX-t.left)/t.width*2-1,ff.y=-((e.clientY-t.top)/t.height)*2+1,df.setFromCamera(ff,qd);let n=df.intersectObjects(Kd.children,!0);for(let e of n){let t=e.object.userData?.agentId;if(t){uf(t);return}}});var mf=new So;function hf(){requestAnimationFrame(hf);let e=Math.min(mf.getDelta(),.1),t=mf.elapsedTime;for(let t of Qd.values())Gu(t,e);if(Xu(ef,e,t),tf.update(e),nf){let n=.6+Math.abs(Math.sin(t*1.6))*.4;nf.beacon.material.color.setRGB(n,1,1),nf.beacon.scale.setScalar(.9+n*.25),Zd?.market?.phase===`open`&&(nf.ring.rotation.z+=e*.5)}af?.visible&&(af.material.opacity=.35+Math.sin(t*3)*.2,af.rotation.z+=e*.3),Yd.update(),Xd.render(),gf++}var gf=0;window.__city={get scene(){return Kd},camera:qd,renderer:Jd,controls:Yd,composer:Xd,get state(){return Zd},get frames(){return gf},entries:Qd,anchors:$d,select:uf},sf();